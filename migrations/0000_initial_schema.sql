...
CREATE TABLE IF NOT EXISTS balances (
  ...
  balance INTEGER DEFAULT 0,                     -- 余额或次数
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  amount INTEGER NOT NULL,                       -- 订单金额或次数
  status TEXT NOT NULL,                          -- 订单状态 ('PENDING', 'SUCCESS', 'FAILED')
  payment_provider_order_id TEXT UNIQUE,         -- 支付服务商订单号
  related_item_url TEXT,                       -- 关联项目URL
  used_invitation_code TEXT NULL,              -- 使用的邀请码
...
CREATE TABLE IF NOT EXISTS invitation_codes (
  ...
  reward_for_invitee INTEGER DEFAULT 1,                   -- 给被邀请人的奖励次数
